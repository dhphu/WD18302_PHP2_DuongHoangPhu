        ...
        ">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <h2>Đổi mật khẩu</h2>
                    <!-- Form -->
                    <form class="form-horizontal mt-3" id="loginform" action="?url=MailerController/changePass"
                        method="post">
                        <div class="row pb-4">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg"
                                        placeholder="Nhập mật khẩu mới" aria-label="" aria-describedby="basic-addon1"
                                        name="newpass" />
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg"
                                        placeholder="Xác nhận mật khẩu" aria-label="" aria-describedby="basic-addon1"
                                        name="repass" />
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="pt-3">
                                        <button class="btn btn-primary float-end text-white" type="submit"
                                            style="margin-right: 10px" name="submit">
                                            Submit
                                        </button>
                                    </div>
                                </div>
