    ...
    <div class="
      ...
      <div class="auth-box bg-dark border-top border-secondary">
        <div>
          ...
          <!-- Form -->
          <form class="form-horizontal mt-3" action="?url=ResgisterController/handleRegister" method="POST">
            <div class="row pb-4">
              <div class="col-12">
              ...
              <div class="col-12">
                <div class="form-group">
                  <div class="pt-3 d-grid">
                    ...
                    <button class="btn btn-success float-end text-white" style="margin-top: 10px">
                      <a href="?url=LoginController/loadViewLogin">Login</a>
                    </button>
                  </div>
                </div>
              </div>
