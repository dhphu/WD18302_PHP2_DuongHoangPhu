      ...
      <div class="auth-box bg-dark border-top border-secondary">
        <div id="loginform">
          <div class="text-center pt-3 pb-3">
            <span class="db"><img src="App/Views/layouts/assets/images/logo.png" alt="logo" /></span>
          </div>
          <!-- Form -->
          <form class="form-horizontal mt-3" id="loginform" action="?url=LoginController/handleLogin" method="post">
            <div class="row pb-4">
              <div class="col-12">
                ...
                <div class="form-group">
                  <div class="pt-3">
                    ...
                    <button class="btn btn-success float-end text-white">
                      <a href="?url=ResgisterController/loadViewRegister">Register</a>
                    </button>
                    <button class="btn btn-primary float-end text-white" type="submit" style="margin-right: 10px"
                      name="submit">
                      Login
                    </button>
                  </div>
        ...
        <div id="recoverform">
          <div class="row mt-3">
            <!-- Form -->
            <form class="col-12" action="?url=MailerController/forgotPass" method="POST">
              <!-- email -->
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                ...
                <input type="text" class="form-control form-control-lg" placeholder="Email Address"
                  aria-label="Username" aria-describedby="basic-addon1" name="email_forgot" />
              </div>
              <?php if (isset($_SESSION['email_forgot'])): ?>
            <div class="text-center">
              <span class="text-white">
                <?php echo Sessions::display_session('email_forgot'); ?>
              </span>
            </div>
          <?php endif; ?>
              ...
              <div class="row mt-3 pt-3 border-top border-secondary">
                <div class="col-12">
                  ...
                  <button class="btn btn-info float-end" type="submit" name="forgot">
                    Recover
                  </button>
                </div>
              </div>
